			...
			if($xz.length == 0){
				...
				$.ajax({
					...
					success : function (data){
						...
						* 	用户列表
						* 	市场活动对象
						* 	{"userList":[{"name"："张三",..},{}],"activity":activity}
						* */
						var html = "<option></option>";
	...
	function pageList(pageNo,pageSize){
		...
		$.ajax({
			...
			success : function (data){
				/*
				* data
				* 	{"total":100,"dataList":[{市场活动列表1},{市场活动列表2},,,]}
				* */
				var html = "";
