	...
	$(function(){
		...
		$("#openSearchActivityModalBtn").click(function () {
			...
			$("#searchActivity").keydown(function (event) {
				if(event.keyCode == 13){
					if($("#searchActivity").val() == ""){
						alert("请输入市场活动名称")
					}else{
						$.ajax({
							url : "workbench/clue/getActivityListForConvert.do",
							data : {
		...
		<div class="modal-dialog" role="document" style="width: 90%;">
			<div class="modal-content">
				...
				<div class="modal-footer">
					...
					<button type="button" id="submitSearchBtn" class="btn btn-primary" data-dismiss="modal">提交</button>
				</div>
			</div>
		</div>
	</div>
	...
	<div id="create-transaction2" style="position: relative; left: 40px; top: 20px; width: 80%; background-color: #F7F7F7; display: none;" >
		...
		<form id="tranForm" action="workbench/clue/convert.do" method="post">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <input type="text" class="form-control time" id="expectedClosingDate" name="exceptedDate">
		  </div>
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		  ...
		  <div class="form-group" style="width: 400px;position: relative; left: 20px;">
		    ...
		    <input type="text" class="form-control" id="activityName" placeholder="点击上面搜索" disabled>
